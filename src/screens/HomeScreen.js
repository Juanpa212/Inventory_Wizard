...
const HomeScreen = ({ navigation }) => {
  ...
  const navigationData = [
    ...
    { id: "6", title: "Go to Inventory Manager Screen", screen: "inventoryManager"},
    { id: "7", title: "Go to Inventory Viewer Screen", screen: "invViewer"},
    { id: "8", title: "Go to Inventory Editor Screen", screen: "editor" },
    { id: "9", title: "Go to Add Items Screen", screen: "add" },
    { id: "10", title: "Go to Invoice Manager Screen", screen: "invoiceManager" },
    { id: "11", title: "Go to Create Invoice Screen", screen: "createInvoice"},
    { id: "12", title: "Go to Help Center Screen", screen: "help"},
    { id: "13", title: "Go to Stock Levels Screen", screen: "stock"},
    { id: "14", title: "Go to Team Viewer Screen", screen: "teamViewer"},
